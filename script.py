...
driver = webdriver.Chrome("/mnt/c/users/admin/downloads/chromedriver.exe")
...
while (True) :
    ...
    try:
        ...
        truck_picker.click()
        driver.implicitly_wait(5)
        truck_type = driver.find_element(By.ID, 'straightTruck_0')  
        driver.implicitly_wait(5)
        truck_type.click()
        driver.implicitly_wait(5)
        truck_width_radio = driver.find_element(By.ID, 'under9Ft_0')  
        driver.implicitly_wait(5)
        truck_width_radio.click()
        driver.implicitly_wait(5)
        truck_length = driver.find_element(By.ID, 'Oversizelengthboxinft_0') 
        truck_length.send_keys('37')
        truck_height = driver.find_element(By.ID, 'Oversizeheightboxinft_0')  
        truck_height.send_keys('13')
